class SymmetricKronecker {
    ...
    public static double[][] symmetric_kronecker_product(double[][] m1, double[][] m2) {
    	...
    	int rowQ = 0, divQ = 0, modQ = 0, columnT = 0, divT = 0, modT = 0;
    	...
    	while (divT + 1 < m1.length) {
    		while (modT < m1.length) {
    			product[0][columnT] = (m1[0][divT] * m2[0][modT] + m1[0][modT] * m2[0][divT]) * inverseSqrt2;
    			columnT++;
    			modT++;
    		}
    
    		divT++;
    		product[0][columnT] = m1[0][divT] * m2[0][divT];
    		modT = divT + 1;
    		columnT++;
    	}
    	...
    	while (divQ + 1 < m1.length) {
    		while (modQ < m1.length) {
    			...
    			while (divT + 1 < m1.length) {
    				while (modT < m1.length) {
    					product[rowQ][columnT] = (m1[divQ][divT] * m2[modQ][divT] + m1[modQ][divT] * m2[divQ][divT] + m1[divQ][modT] * m2[modQ][modT] + m1[modQ][modT] * m2[divQ][modT]) * 0.5;
    					columnT++;
    					modT++;
    				}
    
    				divT++;
    				product[rowQ][columnT] = (m1[divQ][divT] * m2[modQ][divT] + m1[modQ][divT] * m2[divQ][divT]) * inverseSqrt2;
    				modT = divT + 1;
    				columnT++;
    			}
    		...
    		while (divT + 1 < m1.length) {
    			while (modT < m1.length) {
    				product[rowQ][columnT] = (m1[divQ][divT] * m2[divQ][modT] + m1[divQ][modT] * m2[divQ][divT]) * inverseSqrt2;
    				columnT++;
    				modT++;
    			}
    
    			divT++;
    			product[rowQ][columnT] = m1[divQ][divT] * m2[divQ][divT];
    			modT = divT + 1;
    			columnT++;
    		}
